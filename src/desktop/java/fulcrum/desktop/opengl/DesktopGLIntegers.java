...
/**
 * And implementation of the {@link GLIntegers} type for use with the Desktop OpenGL ES 2.0 API.
 * 
 * @author Lonnie Pryor III (lonnie@pryor.us.com)
 */
final class DesktopGLIntegers extends GLIntegers {
  ...
  /** Creates a new Desktop-specific implementation of {@link GLIntegers}. */
  DesktopGLIntegers(int size) {
  ...
  /** Creates a new Desktop-specific implementation of {@link GLIntegers}. */
  DesktopGLIntegers(ByteBuffer raw, IntBuffer buffer, int beginIndex, int endIndex) {
    this.raw = raw;
    this.buffer = buffer;
  ...
  public GLIntegers subData(int beginIndex, int endIndex) {
    ...
    return new DesktopGLIntegers(raw, buffer, this.beginIndex + beginIndex, this.beginIndex + endIndex);
  }

  /* @see GLIntegers#asBytes() */
  @Override
  public GLBytes asBytes() {
    return new DesktopGLBytes(raw, beginIndex * 4, endIndex * 4);
  }
