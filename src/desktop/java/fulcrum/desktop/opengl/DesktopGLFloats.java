...
/**
 * And implementation of the {@link GLFloats} type for use with the Desktop OpenGL ES 2.0 API.
 * 
 * @author Lonnie Pryor III (lonnie@pryor.us.com)
 */
final class DesktopGLFloats extends GLFloats {
  ...
  /** Creates a new Desktop-specific implementation of {@link GLFloats}. */
  DesktopGLFloats(int size) {
  ...
  /** Creates a new Desktop-specific implementation of {@link GLFloats}. */
  DesktopGLFloats(ByteBuffer raw, FloatBuffer buffer, int beginIndex, int endIndex) {
    this.raw = raw;
    this.buffer = buffer;
  ...
  public GLFloats subData(int beginIndex, int endIndex) {
    ...
    return new DesktopGLFloats(raw, buffer, this.beginIndex + beginIndex, this.beginIndex + endIndex);
  }
