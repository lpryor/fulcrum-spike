...
/**
 * And implementation of the {@link GLBytes} type for use with the Desktop OpenGL ES 2.0 API.
 * 
 * @author Lonnie Pryor III (lonnie@pryor.us.com)
 */
final class DesktopGLBytes extends GLBytes {
  ...
  /** Creates a new Desktop-specific implementation of {@link GLBytes}. */
  DesktopGLBytes(int size) {
  ...
  /** Creates a new Desktop-specific implementation of {@link GLBytes}. */
  DesktopGLBytes(ByteBuffer buffer, int beginIndex, int endIndex) {
    this.buffer = buffer;
  ...
  public GLBytes subData(int beginIndex, int endIndex) {
    ...
    return new DesktopGLBytes(buffer, this.beginIndex + beginIndex, this.beginIndex + endIndex);
  }

  /* @see GLBytes#asShorts() */
  @Override
  public GLShorts asShorts() {
    return new DesktopGLShorts(buffer, buffer.asShortBuffer(), beginIndex / 2, endIndex / 2);
  }

  /* @see GLBytes#asIntegers() */
  @Override
  public GLIntegers asIntegers() {
    return new DesktopGLIntegers(buffer, buffer.asIntBuffer(), beginIndex / 4, endIndex / 4);
  }

  /* @see GLBytes#asFloats() */
  @Override
  public GLFloats asFloats() {
    return new DesktopGLFloats(buffer, buffer.asFloatBuffer(), beginIndex / 4, endIndex / 4);
  }
