...
/**
 * And implementation of the {@link GLShorts} type for use with the Android OpenGL ES 2.0 API.
 * 
 * @author Lonnie Pryor III (lonnie@pryor.us.com)
 */
final class AndroidGLShorts extends GLShorts {
  ...
  /** Creates a new Android-specific implementation of {@link GLShorts}. */
  AndroidGLShorts(int size) {
  ...
  /** Creates a new Android-specific implementation of {@link GLShorts}. */
  AndroidGLShorts(ByteBuffer raw, ShortBuffer buffer, int beginIndex, int endIndex) {
    this.raw = raw;
    this.buffer = buffer;
  ...
  public GLShorts subData(int beginIndex, int endIndex) {
    ...
    return new AndroidGLShorts(raw, buffer, this.beginIndex + beginIndex, this.beginIndex + endIndex);
  }

  /* @see GLShorts#asBytes() */
  @Override
  public GLBytes asBytes() {
    return new AndroidGLBytes(raw, beginIndex * 2, endIndex * 2);
  }
